...
--readFilesIn /gpfs/gss1/work/sduhumac/data/jeanette/G56-sampleB4_rnaseq_HGTHHDSXX_R1.fastq.gz /gpfs/gss1/work/sduhumac/data/jeanette/G56-sampleB4_rnaseq_HGTHHDSXX_R2.fastq.gz \
--outFileNamePrefix B4 \
