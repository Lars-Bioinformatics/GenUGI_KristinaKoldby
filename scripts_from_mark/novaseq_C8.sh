...
--readFilesIn /gpfs/gss1/work/sduhumac/data/jeanette/G56-sampleC8_rnaseq_HGTHHDSXX_R1.fastq.gz /gpfs/gss1/work/sduhumac/data/jeanette/G56-sampleC8_rnaseq_HGTHHDSXX_R2.fastq.gz \
--outFileNamePrefix C8 \
