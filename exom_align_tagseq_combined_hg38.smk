...
rule version_log:
    input:
        markdup = expand("hg38/MarkDuplicates/quality_control/{famname}_multiqc_report.html", famname=FAMNAME),
        connor = expand("hg38/Connor/quality_control/{famname}_connor_multiqc_report.html", famname=FAMNAME)
    output:
