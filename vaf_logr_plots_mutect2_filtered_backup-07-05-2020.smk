...
rule all:
    input:
        expand("vaf_log2r_plots/plot_tables/{sample}_somatic_mutect2_log2r_TumorADmin10-NormADmax1-NormDPmin20.txt", sample=SAMPLES)
...
rule add_log2r_to_vcf:
    ...
    output:
        "vaf_log2r_plots/{sample}_somatic_mutect2_log2r.vcf.gz"
    shell:
        """
        bcftools annotate \
        -a {input.ngcgh} \
...
rule filter_vcf:
    input:
        "vaf_log2r_plots/{sample}_somatic_mutect2_log2r.vcf.gz"
    output:
        "vaf_log2r_plots/{sample}_somatic_mutect2_log2r_TumorADmin10-NormADmax1-NormDPmin20.vcf.gz"
    shell:
        """
        bcftools filter \
        --include 'FORMAT/AD[1:1] >= 10 && FORMAT/AD[0:1] <= 1 && FORMAT/DP[0] >= 20 && FILTER="PASS"' \
        {input} \
        -o {output}
        """
...
rule create_plot_table:
    input:
        "vaf_log2r_plots/{sample}_somatic_mutect2_log2r_TumorADmin10-NormADmax1-NormDPmin20.vcf.gz"
    output:
        "vaf_log2r_plots/plot_tables/{sample}_somatic_mutect2_log2r_TumorADmin10-NormADmax1-NormDPmin20.txt"
    shell:
        """
        bcftools query \
        -H \
...
#     input:
#         "vaf_log2r_plots/{sample}_somatic_mutect2_log2r_TumorADmin10-NormADmax1-NormDPmin20.vcf"
#     output:
#         "vaf_log2r_plots/{sample}_somatic_mutect2_log2r_TumorADmin10-NormADmax1-NormDPmin20_passed.txt"
#     shell:
#         """
#         awk \
#         -v FS='\t' \
...
# rule tmp_file1:
#     input:
#         "vaf_log2r_plots/{sample}_somatic_mutect2_log2r_filtered_TumorADmin10-NormADmax1-NormDPmin20_passed.txt"
#     output:
...
#     output:
#         "vaf_log2r_plots/plot_tables/{sample}_somatic_mutect2_log2r_af_filtered_TumorADmin10-NormADmax1-NormDPmin20.txt"
#     shell:
#         """
