...
PATIENTS = ["ECV2-4", "ECV2-8", "ECV2-29", "ECV2-31", "ECV2-35", "PC1-10", "PC1-14", "PC1-18"]
# PATIENTS = ["ECV2-4"]
...
rule mpileup:
    input:
        bam = lambda wildcards: [b+"_tagseq-medexome.connor.recalibrated.bam" for b in config[wildcards.sample]["all"]],
